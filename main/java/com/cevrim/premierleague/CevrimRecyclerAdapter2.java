...
public class CevrimRecyclerAdapter2 extends RecyclerView.Adapter<CevrimRecyclerAdapter2.cevrimviewholder2> {
    ...
    String hometeams[],awayteams[],date[],time[],stadium[];
    int imagesht[],imagesat[];
    Context context;
    public CevrimRecyclerAdapter2(Context ct,String s1[],String s2[],String s3[],String s4[],String s5[],int img1[],int img2[]){
        context=ct;
        hometeams=s1;
        awayteams=s2;
        date=s3;
    ...
    public void onBindViewHolder(@NonNull cevrimviewholder2 holder, int position) {
        ...
        holder.iv_home.setImageResource(imagesht[position]);
        holder.iv_away.setImageResource(imagesat[position]);
    }
